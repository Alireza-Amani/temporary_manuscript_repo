...
class MESHParameters:
    ...
    def read_csvfile(self):
        ...
        self.df_lyinfo = pd.read_csv(self.lyinfo_path, index_col=False)
        self.parameters["nsoil_layers"] = len(self.df_lyinfo["layer_nr"])

        # read the model internal parameter
    ...
    def create_file(self):
        ...
        for line_i, param_i in enumerate(self.param_names_cols.keys()):
            ...
            if param_i == "vf_type":
                ...
                vf_values[self.parameters[param_i] - 1] = 1.0
